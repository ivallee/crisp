...
module.exports = (knex) => {
  ...
  return { createUser, getUserByName, getUserByID, isValidLogin, getUserFilters, getUserCategories, getUserRecipes, createCategory, renameCategory, deleteCategory, saveRecipe, categorizeRecipe, deleteRecipe, saveFilter, deleteFilter, updateFilter };
};